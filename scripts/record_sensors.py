...
def main():
    ...
    parser.add_argument("-i","--input",help="Enter the canbus channel you want to record", default=None)
    parser.add_argument("-v","--verbose",help="Print out what you are recording", default=False)
