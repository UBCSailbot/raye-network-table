...
// DON'T KNOW THE ACTUAL IDS YET. MAKE SURE TO COORDINATE AND SET IDS ACCORDINGLY
#define BMS_FRAME_ID_1       0x00000008
#define BMS_FRAME_ID_2       0x00000009
#define BMS_FRAME_ID_3       0x0000000A
...
#define GET_STATUS(data) {\
    static_cast<bool>(data[7] & 0b0001)\
}
#define GET_VAR_WEST(data) {\
    static_cast<bool>(data[7] & 0b0010)\
}
#define GET_VAR_NORTH(data) {\
    static_cast<bool>(data[7] & 0b0100)\
}
#define GET_LONG_WEST(data) {\
    static_cast<bool>(data[7] & 0b1000)\
}
